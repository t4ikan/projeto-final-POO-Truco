...
public class Dupla {
    ...
    public int getQuedasGanhas() { return quedasGanhas; }
    public int getQuedasJogadas() { return quedasJogadas; }

    public void registrarVitoriaQueda() { this.quedasGanhas++; }
    public void registrarParticipacaoQueda() { this.quedasJogadas++; }
